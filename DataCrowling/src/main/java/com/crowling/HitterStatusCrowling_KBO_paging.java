...
public class HitterStatusCrowling_KBO_paging {
    
    private WebDriver driver;
    private String hitterUrl;
    
    // 새로운 엑셀 파일 경로
    private String newExcelFilePath = "2024_KBO_Hitter_Status.xlsx";
    ...
    public HitterStatusCrowling_KBO_paging() {
        // WebDriver 경로 설정
    ...
    public static void main(String[] args) {
        HitterStatusCrowling_KBO_paging psc = new HitterStatusCrowling_KBO_paging();
        psc.activateBot();
    }
}