...
public class PitcherStatusCrowling {
	...
	public void activateBot() {
		try {
	        ...
	        try (Workbook workbook = new XSSFWorkbook()) {
                ...
                String[] headers = {"Rank", "p_no", "Name", "year", "position", "Team", "WAR", "G", "GS", "GR", "GF", "W", "L", "S", "HD", "IP", "ER", "R", "rRA", "TBF", "H", "2B", "3B", "HR", "BB", "HP", "IB", "SO", "ROE", "BK", "WP", "ERA", "RA9", "rRA9", "rRA9pf", "FIP", "WHIP", "WAR"};
	...
	public static void main(String[] args) {
		...
		PitcherStatusCrowling psc = new PitcherStatusCrowling();
		psc.activateBot();
