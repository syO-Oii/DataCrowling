...
public class ProfileCrowling {
	String excelFilePath = "dummy.xlsx";
		...
		try (FileInputStream excelFile = new FileInputStream(excelFilePath);
	            ...
	            for (int rowIndex = 1; rowIndex <= sheet.getLastRowNum(); rowIndex++) {
	                ...
	                if (pNoCell != null && pNoCell.getCellType() == CellType.STRING) {
	                    ...
	                    // 크롤링할 데이터 요소 선택
	                    WebElement birthElement = driver.findElement(By.xpath("/html/body/div[2]/div[3]/section/div[3]/div[1]/ul/li[1]"));
	                    WebElement totaElement = driver.findElement(By.xpath("/html/body/div[2]/div[3]/section/div[3]/div[1]/div[3]/div[2]/span[3]"));
